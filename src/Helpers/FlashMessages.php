...
class FlashMessages {
    ...
    protected $msgWrapper = "<div class='%s text-center'>%s</div>\n";
    ...
    protected $cssClassMap = [
        ...
        self::PINK    => 'alert-pink',
        self::PURPLE  => 'alert-purple',
        self::MINT    => 'alert-mint',
     ...
     *
     */
    public function info($message, $redirectUrl=null, $sticky=true)
    {
     ...
     *
     */
    public function success($message, $redirectUrl=null, $sticky=true)
    {
     ...
     *
     */
    public function warning($message, $redirectUrl=null, $sticky=true)
    {
     ...
     *
     */
    public function error($message, $redirectUrl=null, $sticky=true)
    {
     ...
     *
     */
    public function add($message, $type=self::defaultType, $redirectUrl=null, $sticky=true)
    {
